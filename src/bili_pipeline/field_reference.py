...
FIELD_DEFINITIONS: tuple[FieldDefinition, ...] = (
    ...
    FieldDefinition("CommentSnapshot", "snapshot_time", "评论抓取时间", "时间", "最新评论快照的采集时间。", "2026-03-15T14:33:02"),
    FieldDefinition("CommentSnapshot", "limit", "评论抓取条数上限", "连续", "本次计划抓取的最新评论条数。", "10"),
    FieldDefinition("CommentSnapshot", "comment_top10", "最新评论列表", "复合", "按时间顺序截取的评论对象列表。", '[{"rpid": 99887766, "message": "讲得很清楚"}]'),
    ...
    FieldDefinition("MediaResult", "video_object_key", "视频对象键", "文本", "视频流文件在 SQLite / OSS 中的定位键。", "bilibili-media/BV1xx411c7mD/1486239001/video.m4s"),
    FieldDefinition("MediaResult", "audio_object_key", "音频对象键", "文本", "音频流文件在 SQLite / OSS 中的定位键。", "bilibili-media/BV1xx411c7mD/1486239001/audio.m4s"),
    ...
    FieldDefinition("MediaAssetRef", "storage_backend", "存储后端", "离散", "媒体文件实际写入的存储位置类型。", "oss"),
    ...
    FieldDefinition("MediaAssetRef", "bucket_name", "OSS Bucket 名称", "离散", "若使用 OSS，则记录目标 Bucket 名称。", "thesis-bilibili-media"),
    FieldDefinition("MediaAssetRef", "storage_endpoint", "存储端点", "文本", "当前媒体对象所在的 OSS Endpoint。", "https://oss-cn-hangzhou.aliyuncs.com"),
    FieldDefinition("MediaAssetRef", "object_url", "对象访问 URL", "文本", "媒体对象的可访问 URL 或定位 URL。", "https://cdn.example.com/bilibili-media/BV1xx411c7mD/1486239001/video.m4s"),
